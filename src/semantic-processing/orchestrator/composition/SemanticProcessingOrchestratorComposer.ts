...
export class SemanticProcessingOrchestratorComposer {
  ...
  static async resolve(
    ...
    const [projectionModule, strategyRegistryModule] = await Promise.all([
      import("../../projection/index.js").then((m) =>
        m.projectionFactory(projectionPolicy),
      ),
      import("../../strategy-registry/index.js").then((m) =>
   ...
   */
  private static async createVectorStore(
    _policy: SemanticProcessingOrchestratorPolicy,
