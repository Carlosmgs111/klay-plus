...
export declare class NeDBSemanticProjectionRepository implements SemanticProjectionRepository {
    private store;
...
//# sourceMappingURL=NeDBSemanticProjectionRepository.d.ts.map