export class StrategyRegistryComposer {
    static async resolve(policy) {
        ...
        switch (policy.type) {
            case "in-memory": {
                const { InMemoryProcessingStrategyRepository } = await import("../infrastructure/persistence/InMemoryProcessingStrategyRepository.js");
                return {
            ...
            case "browser": {
                const { IndexedDBProcessingStrategyRepository } = await import("../infrastructure/persistence/indexeddb/IndexedDBProcessingStrategyRepository.js");
            ...
            case "server": {
                const { NeDBProcessingStrategyRepository } = await import("../infrastructure/persistence/nedb/NeDBProcessingStrategyRepository.js");
...
//# sourceMappingURL=StrategyRegistryComposer.js.map