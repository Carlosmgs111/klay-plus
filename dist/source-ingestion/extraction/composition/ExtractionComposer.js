export class ExtractionComposer {
    static async createDefaultExtractor() {
        const { CompositeContentExtractor } = await import("../infrastructure/adapters/CompositeContentExtractor.js");
        const { TextContentExtractor } = await import("../infrastructure/adapters/TextContentExtractor.js");
        const { PdfContentExtractor } = await import("../infrastructure/adapters/PdfContentExtractor.js");
